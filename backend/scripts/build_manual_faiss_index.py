...
from backend.app.core.database import get_properties_collection
from backend.app.services.property_formatter import convert_property_to_text
from backend.app.services.manual_rag.embedding_service import generate_embedding
from backend.app.services.manual_rag.vector_store_service import add_embeddings_to_index, save_faiss_index
